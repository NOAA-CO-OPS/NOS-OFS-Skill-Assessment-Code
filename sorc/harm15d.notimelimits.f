...
!      AZI=XMAJOR
      ...
      ITYPE=3
C*****************************
      NJ=1   !! number of harmonic analysis to do
      IAND=0  !! read in ascii format data file
      IREF=0  !! 
      IIT=0    !! number of iteration
      ISKIP9=0
      IEL=KINDAT-1
C****************************
...
c      logical extst
     ...
     13.5,-8.2,-12.5,-16.0,-18.4,-18.9,-16.8,-11.3,-2.8/                  
      DATA(TAB2(JZ),JZ=1,18)/-0.31,-0.25,-0.15,-0.04,0.07,0.17,0.25,0.30  
     1,0.33,0.32,0.28,0.22,0.13,0.03,-0.08,-0.19,-0.28,-0.32/             
     ...
     1-0.27,-0.25,-0.20,-0.13,-0.03,0.06,0.14,0.21,0.25,0.27/            
      DATA(TAB5(JZ),JZ=1,37)/-0.4,-1.0,-1.5,-2.0,-2.4,-2.7,-3.0,-3.2,2*- 
     13.4,-3.3,-3.1,-2.8,-2.4,-1.9,-1.4,-0.8,-0.2,0.5,1.1,1.6,2.1,2.6,2. 
     29,3.2,3.3,3.4,3.3,3.2,2.9,2.6,2.2,1.7,1.2,0.7,0.1,-0.4/           
      DATA(TAB6(JZ),JZ=1,37)/2*1.06,2*1.05,1.04,1.03,1.02,1.01,2*1.00,0.
     199,0.98,0.97,0.96,2*0.95,3*0.94,2*0.95,2*0.96,0.97,0.98,0.99,1.00,
     21.01,1.02,1.03,2*1.04,1.05,4*1.06/                                
      DATA(TXXIXA( J ),J=1,20)/0.000,0.579,0.016,2*0.0,0.088,0.579,0.080 
     1,0.054,0.026,0.672,0.016,0.672,7*0.0/                            
      DATA(TXXIXB( J ),J=1,20)/20*0.0/                                 
      DATA(TXXIXC( J ),J=1,20)/0.016,0.200,3*0.0,0.989,0.672,0.049,2*0.9
     197,0.579,0.016,0.214,7*0.0/                                       
      DATA(TXXIXD( J ),J=1,20)/4*0.0,0.024,8*0.0,0.207,0.615,0.024,0.054 
     1,0.626,0.016,0.711/                                               
      DATA(TXXIXE( J ),J=1,20)/3*0.0,0.024,9*0.0,2*0.626,0.024,0.990,0.2 
     107,0.020,0.216/                                                    
      DATA(TXXIXF( J ),J=1,20)/0.0,262.,3.,2*0.0,18.,98.,344.,10.,175.,8 
     15.,357.,275.,7*0.0/                                                
      DATA(TXXIXG( J ),J=1,20)/20*0.0/                                   
      DATA(TXXIXH( J ),J=1,20)/357.,259.,3*0.0,15.,275.,341.,7.,353.,262 
     1.,354.,272.,7*0.0/                                                
      DATA(TXXIXI( J ),J=1,20)/4*0.0,4.,8*0.0,96.,93.,9.,171.,269.,357., 
     1281./                                                               
      DATA(TXXIXJ( J ),J=1,20)/3*0.0,356.,9*0.0,91.,269.,4.,346.,264.,35  
     13.,276./                                                           
